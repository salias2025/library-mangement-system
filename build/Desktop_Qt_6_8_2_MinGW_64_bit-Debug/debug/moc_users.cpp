...
static constexpr auto qt_meta_stringdata_ZN5usersE = QtMocHelpers::stringData(
    "users"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN5usersE[] = {
...
Q_CONSTINIT const QMetaObject users::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN5usersE.offsetsAndSizes,
    qt_meta_data_ZN5usersE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN5usersE_t,
        // Q_OBJECT / Q_GADGET
...
void *users::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN5usersE.stringdata0))
