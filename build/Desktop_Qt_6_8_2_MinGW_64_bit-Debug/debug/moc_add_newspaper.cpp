...
namespace {
struct qt_meta_tag_ZN13add_newspaperE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN13add_newspaperE = QtMocHelpers::stringData(
    "add_newspaper",
    "limitTextSize",
    "",
    "on_submit_clicked"
...
Q_CONSTINIT static const uint qt_meta_data_ZN13add_newspaperE[] = {
...
Q_CONSTINIT const QMetaObject add_newspaper::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_ZN13add_newspaperE.offsetsAndSizes,
    qt_meta_data_ZN13add_newspaperE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13add_newspaperE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<add_newspaper, std::true_type>,
...
void *add_newspaper::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13add_newspaperE.stringdata0))
