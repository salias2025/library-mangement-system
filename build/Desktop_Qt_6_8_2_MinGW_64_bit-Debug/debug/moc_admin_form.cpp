...
static constexpr auto qt_meta_stringdata_ZN10admin_formE = QtMocHelpers::stringData(
    "admin_form",
    "on_submit_clicked",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN10admin_formE[] = {
...
Q_CONSTINIT const QMetaObject admin_form::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10admin_formE.offsetsAndSizes,
    qt_meta_data_ZN10admin_formE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10admin_formE_t,
        // Q_OBJECT / Q_GADGET
...
void *admin_form::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10admin_formE.stringdata0))
